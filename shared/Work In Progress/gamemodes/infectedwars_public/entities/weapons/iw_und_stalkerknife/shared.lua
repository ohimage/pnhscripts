...
SWEP.Contact = ""
SWEP.Purpose = ""
SWEP.Instructions = "Give a deadly stab to your enemies. Alternate fire releases the Scream of Disorientation."
...
SWEP.ScreamSound = Sound("npc/stalker/go_alert2a.wav")
